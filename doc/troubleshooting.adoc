...
- Verify that the PVC is requested with at least 10% less than the KadaluStorage    
Kadalu adheres to Gluster's reserve (10%) and will refuse to create the PV/PVC if the PVC request > (total size - reserve)
