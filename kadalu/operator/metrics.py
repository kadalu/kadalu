...
total_number_of_containers = Gauge(
    'kadalu_total_number_of_containers',
    'Kadalu Total Number Of Containers', ['name']
)
number_of_ready_containers = Gauge(
    'kadalu_total_number_of_ready_containers',
    'Kadalu Total Number Of Ready Containers', ['name']
)

total_capacity_bytes = Gauge(
    'kadalu_storage_total_capacity_bytes',
    'Kadalu Total Storage Capacity', ['name']
)
used_capacity_bytes = Gauge(
    'kadalu_storage_used_capacity_bytes',
    'Kadalu Total Storage Used Capacity', ['name']
)
free_capacity_bytes = Gauge(
    'kadalu_storage_free_capacity_bytes',
    'Kadalu Total Storage Free Capacity', ['name']
)
...
total_pvc_capacity_bytes = Gauge(
    'kadalu_pvc_total_capacity_bytes', 'Kadalu Total PVC Capacity', ['name'])
used_pvc_capacity_bytes = Gauge(
    'kadalu_pvc_used_capacity_bytes', 'Kadalu Total PVC Used Capacity', ['name'])
free_pvc_capacity_bytes = Gauge(
    'kadalu_pvc_free_capacity_bytes', 'Kadalu Total PVC Free Capacity', ['name'])
