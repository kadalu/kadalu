...
RUN apt-get update -yq && \
    ...
    libfuse-dev libuuid1 uuid-dev acl-dev libtool automake autoconf git pkg-config libxml2-dev python3-venv libffi-dev && \
    ...
    python3-pip sqlite build-essential g++ python3-dev flex bison openssl libssl-dev libtirpc-dev liburcu-dev \
    libfuse-dev uuid-dev acl-dev libtool automake autoconf git pkg-config libxml2-dev && \
    apt-get -y clean && \
